...
/**
 * Shaped like the page it stands in for: heading, four summary cards, then the receipt ledger
 * taking the rest of the height. A generic bar stack would promise a layout this route does not
 * have, and everything would move on the swap to real content.
 */
export default function ReceiptsLoading() {
  return (
    <div className="page-enter flex flex-1 flex-col lg:min-h-0">
      <header className="mb-6">
        <Skeleton className="h-9 w-44 rounded-[3px]" />
