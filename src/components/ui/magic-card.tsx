...
export function MagicCard(props: MagicCardProps) {
  ...
  // The app is dark-only, so the theme lookup is a constant. Dropping it removes next-themes and
  // the ThemeProvider this component would otherwise have needed at the root.
