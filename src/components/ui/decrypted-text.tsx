...
/* eslint-disable react-hooks/set-state-in-effect --
   Vendored as published. The one flagged effect resyncs the scramble when `text` changes; it cannot
   move into render because shuffling calls Math.random. Every call site here passes a constant. */

/**
 * React Bits' DecryptedText, unmodified except for this header and the client directive.
 * DESIGN_INTEL.md section 5: Razorpay's /ai-builders headlines arrive scrambled and decode in place.
 * Used here only on reason codes, which are monospace, so the scramble cannot reflow a table row.
 */
